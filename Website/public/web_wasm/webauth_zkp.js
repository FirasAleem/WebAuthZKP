...
* @returns {any}
*/
export function run_js(client_data_json_base64, auth_data_base64, challenge_base64) {
    try {
...
* @returns {boolean}
*/
export function verify_js(message_base64, challenge_base64, proof_base64, vk_base64) {
    try {
        const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
...
async function __wbg_init(input) {
    ...
    if (typeof input === 'undefined') {
        input = new URL('webauth_zkp_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
